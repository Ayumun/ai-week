...
2. 作成完了後、自動的にコミット＆プッシュ
   ...
   - ブランチは現在のブランチにプッシュ
3. **そのまま次のステップ（GitHub Issueへのタスク記述）に進む**
